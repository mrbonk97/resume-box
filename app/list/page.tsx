...
const ListPage = () => {
  return (
    <main className="min-h-full w-full flex2 flex-col gap-20 py-24">
      <h1 className="text-5xl font-semibold">이력서 선택해주세요</h1>
      <section className="w-full px-20">
        <ul className="flex flex-wrap items-center justify-center gap-10">
          <li>
            <Card className="h-96 w-80 flex2">
              <CardContent className="h-full flex items-center flex-col justify-evenly">
                <span className="text-4xl font-semibold">새로운 이력서</span>
                <Link href="/create">
          ...
          <li>
            <Card className="h-96 w-80 flex2">
              <CardContent className="h-full flex items-center flex-col justify-evenly">
                <span className="text-4xl font-semibold">이력서1</span>
                <Button variant={"ghost"} className="h-32 w-32 rounded-full">
